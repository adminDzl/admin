...
@Controller
@RequestMapping(value="/usercarbind")
public class UserCarBindController extends BaseController {

	String menuUrl = "usercarbind/list.do";
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, "新增UserCarBind");
		//校验权限
	...
	public void delete(PrintWriter out){
		logBefore(logger, "删除UserCarBind");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "del")){return;}
		PageData pd = this.getPageData();
		usercarbindService.delete(pd);
		out.write("success");
		out.close();
	}
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, "修改UserCarBind");
	...
	public ModelAndView list(Page page){
		logBefore(logger, "列表UserCarBind");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增UserCarBind页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
	...
	public ModelAndView goEdit(){
		logBefore(logger, "去修改UserCarBind页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = this.getPageData();
	...
	public Object deleteAll() {
		logBefore(logger, "批量删除UserCarBind");
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			usercarbindService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出UserCarBind到excel");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "cha")){return null;}
