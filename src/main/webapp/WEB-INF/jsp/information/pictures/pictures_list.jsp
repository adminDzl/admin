						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td style="width: 100px;" class="center">
									...
									<c:if test="${QX.edit == 1 }">
										<a class='btn btn-mini btn-info' title="编辑" onclick="edit('${var.PICTURES_ID}');"><i class="icon-edit"></i></a>
									</c:if>
									<c:if test="${QX.del == 1 }">
										<a class='btn btn-mini btn-danger' title="删除" onclick="del('${var.PICTURES_ID}');"><i class='icon-trash'></i></a>
									</c:if>
								</td>
							</tr>
