			...
			<table>
				<tr>
					...
					<td style="vertical-align:top;"> 
					 	<select name="PAY_STATUS" id="PAY_STATUS" data-placeholder="支付状态" style="vertical-align:top;width: 120px;">
					...
					<c:when test="${not empty varList}">
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td>
									<c:if test="${var.PAY_TYPE == 1 || var.PAY_TYPE == 2 || var.PAY_TYPE == 3}"><span class="label label-success arrowed">企业缴费</span></c:if>
								</td>
								<td>${var.NAME}</td>
