			...
			<table>
				<tr>
					...
					<td style="vertical-align:top;"> 
					 	<select name="PLACE_TYPE" id="PLACE_TYPE" data-placeholder="请选择场地类型" style="vertical-align:top;width: 120px;">
							<option value="" disabled selected style="display:none;">请选择场地类型</option>
