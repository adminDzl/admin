				...
				<tr>
					<td>
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="NAME" value="" placeholder="这里输入车主姓名" />
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td style="width: 50px;" class="center">
									...
									<c:if test="${QX.edit == 1 }">
										<a style="cursor:pointer;" title="编辑" onclick="edit('${var.USER_CAR_BIND_ID}');" class="tooltip-success" data-rel="tooltip" title="" data-placement="left"><span class="green"><i class="icon-edit"></i></span></a>
									</c:if>
									<c:if test="${QX.del == 1 }">
